  ...
  return (
    <>
        ...
        <div className="row">
          ...
          <div className="col-md-7">
            <div className="main-description px-2">
              <div className="place-title text-bold my-3">{KohKong.name}</div>

              <div className="place-details my-4">
                <p className="details-title text-color mb-1">Place Details</p>
                <p className="description">{KohKong.description[0]}</p>
              </div>
              ...
              <div className="transportation-container">
                ...
                <div className="transportation-options my-2 mx-4 ms-2 d-inline-block mr-3">
                  ...
                  <p className="text-secondary">{KohKong.transportation[0]}</p>
                </div>
                ...
                <div className="transportation-options my-2 mx-4 d-inline-block mr-3">
                  ...
                  <p className="text-secondary">{KohKong.transportation[1]}</p>
                </div>
                ...
                <div className="transportation-options my-2 mx-4 d-inline-block mr-3">
                  ...
                  <p className="text-secondary">{KohKong.transportation[2]}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container nearby-places my-4">
        ...
        <div className="row">
          {KohKong.placeNearby.map((place, index) => (
